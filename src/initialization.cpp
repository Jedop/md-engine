...
std::vector<Particle> init_fcc_lattice(int unit_cells_per_side, double box_length) {
    std::vector<Particle> Particles;
    double a = box_length / unit_cells_per_side;
    int N = 4 * (unit_cells_per_side * unit_cells_per_side * unit_cells_per_side); // 4000 atoms
...
std::vector<Particle> init_sc_lattice(int particles_per_side, double box_length) {
    std::vector<Particle> Particles;
