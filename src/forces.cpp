...
std::pair<std::vector<Vec3>, double> compute_all_forces(const std::vector<Particle>& Particles,
                                                        const std::vector<int>& head,
                                                        const std::vector<int>& next, int nx,
                                                        double cell_size, double box) {
    ...
    std::vector<std::vector<Vec3>> thread_acc(num_threads,
                                              std::vector<Vec3>(Particles.size(), {0, 0, 0}));
#pragma omp parallel
    {
