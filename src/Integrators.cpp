...
void Euler::step2(std::vector<Particle>& Particles, const std::vector<Vec3>& new_accelerations,
                  double dt) {
...
void Leapfrog::step2(std::vector<Particle>& Particles, const std::vector<Vec3>& new_accelerations,
                     double dt) {
    for (size_t i = 0; i < Particles.size(); i++) {
        Particles[i].acceleration = new_accelerations[i];
